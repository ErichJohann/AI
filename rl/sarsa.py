...
class SarsaAgentTabular:
    """
    SARSA (On-Policy) agent for discrete environments.
    """
    ...
    def __init__(
        ...
        if self.verbose:
            print(f"SARSA-table initialized with shape {self.q_table.shape}")

    def choose_action(self, state: int, is_in_exploration_mode: bool = True) -> int:
        """ε-greedy action selection (Igual ao Q-learning)."""
    ...
    def train(self, num_episodes: int):
        ...
        if self.verbose:
            print("\n===========================================")
            print("SARSA-table before training:")
            print(self.q_table)
        ...
        if self.verbose:
            print("\n===========================================")
            print("SARSA-table after training:")
            print(self.q_table)
